...
--	{title="Apartment", colour=0, id=40, x=291.50, y=-1078.56, z=28.4},
...
--	{title="House", colour=0, id=40, x=-1288.000, y=440.748, z=97.69459},
	...
	-- Businesses --
	--{title="Cocaine Lockup", colour=0, id=497, x=1196.76, y=-3253.72, z=7.10},
	--{title="Counterfeit Cash Factory", colour=49, id=500, x=-1166.843, y=-1386.159, z=4.971},
	--{title="Document Forgery Office", colour=81, id=498, x = 259.65, y = -3059.75, z = 5.86},
	--{title="Meth Lab", colour=30, id=499, x=1181.816, y=-3113.832, z=6.028},
	--{title="Weed Farm", colour=24, id=496, x = 858.59, y = -3202.55, z = 5.99},
	-- Facility --
	...
	-- Vehicle Warehouse --
	--{title="Vehicle Warehouse", colour=33, id=524, x=-668.50, y=-2385.95, z=13.93},
	-- Crate Warehouses --
	--{title="Crate Warehouse", colour=83, id=473, x=926.66, y=-1560.23, z=30.74},
	--{title="Crate Warehouse", colour=83, id=473, x=-324.90, y=-1356.23, z=31.30},
	--{title="Crate Warehouse", colour=83, id=473, x=274.54, y=-3015.40, z=5.70},
	-- Clubhouses --
